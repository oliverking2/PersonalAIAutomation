...
TASK_TOOL_CONFIG = CRUDToolConfig(
    ...
    create_description=(
        ...
        f"**Project linking**: When creating multiple related tasks (3+), or tasks that are "
        f"clearly part of a larger initiative, suggest organising them into a project. "
        f"Use query_projects first to check for existing projects that match. "
        f"If no suitable project exists, offer to create one before creating the tasks. "
        f"Don't suggest projects for unrelated or one-off tasks. "
    ...
    update_description=(
        ...
        f"**Project linking**: When updating tasks that share a common theme or goal, "
        f"suggest linking them to a project. Query for existing projects first, "
        f"or offer to create a new project if none exists. "
